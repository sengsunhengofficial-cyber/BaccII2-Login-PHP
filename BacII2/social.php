...
$subjects = getSocialSubjects();

if (!isset($_SESSION['social_students'])) {
    $_SESSION['social_students'] = [];
}
...
<body>
    ...
    <nav>
        ...
        <a href="science.php">Science Class</a>
    </nav>
    ...
    <?php if (count($_SESSION['social_students']) > 0): ?>
        <table>
            <tr>
                <th>#</th>
                <th>Name</th>
            ...
            <?php foreach ($_SESSION['social_students'] as $i => $student): ?>
                <tr>
                    <td><?php echo $i + 1; ?></td>
        ...
        <a class="reset-link" href="social.php?reset=1">Clear all records</a>
    <?php else: ?>
